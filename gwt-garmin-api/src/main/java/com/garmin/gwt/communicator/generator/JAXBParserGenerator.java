package com.garmin.gwt.communicator.generator;
...
public class JAXBParserGenerator extends Generator {
	...
	private static String GWTJAXB_LIB_PACKAGE = "com.garmin.gwt.communicator.client.jaxb.*";
	private static String GWTJAXB_UTILS_PACKAGE = "com.garmin.gwt.communicator.client.jaxb.utils.*";
	private static String GWT_XML_PACKAGE = "com.google.gwt.xml.client.*";
	private static String JAVA_UTIL_PACKAGE = "java.util.*";
	...
	public SourceWriter getSourceWriter(JClassType classType,
		...
		composer.addImport(GWT_XML_PACKAGE);
		composer.addImport(GWTJAXB_LIB_PACKAGE);
	...
	public SourceWriter getFactorySourceWriter(Class<?> classType,
		...
		composer.addImport(GWT_XML_PACKAGE);
		composer.addImport(GWTJAXB_LIB_PACKAGE);
		composer.addImport(GWTJAXB_UTILS_PACKAGE);
		composer.addImport(JAVA_UTIL_PACKAGE);
