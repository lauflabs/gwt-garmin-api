...
@JAXBBindings(value=Gpx.class, objects={TrackPoint.class,Link.class,Track.class,TrackSegment.class,WayPoint.class,Route.class,Bounds.class,Copyright.class,Person.class,MetaData.class,Email.class})
